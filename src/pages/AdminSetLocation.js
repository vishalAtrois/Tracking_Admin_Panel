...
const fetchUserOutsidePoints = (user) => {
  ...
  fetch(`https://tracking-backend-admin.vercel.app/v1/admin/getUserOutsideAreaHistory?userId=${user.id}`, requestOptions)
    ...
    .then((result) => {
     ...
     if (assignedAreaId) {
  fetch(`https://tracking-backend-admin.vercel.app/v1/admin/getAssignAreaToUser?locationId=${assignedAreaId}`, requestOptions)
    .then((res) => res.json())
    .then((areaResult) => {
...
fetch(`https://tracking-backend-admin.vercel.app/v1/admin/getAssignAreaToUser?locationId=${item.assignedAreaId}`, requestOptions)
  .then((response) => response.json())
  .then((result) => {
...
const SetLocation = () => { 
  ...
  fetch("https://tracking-backend-admin.vercel.app/v1/admin/assignAreaToUser", {
    method: "POST",
    headers: {
